...
function GetPackageHeader(Conn: TIBConnection; APackageName: string): TStringList;
function GetPackageBody(Conn: TIBConnection; APackageName: string): TStringList;
function GetPackageDeclaration(Conn: TIBConnection; APackageName: string): TStringList;
