...
//maurog
procedure RIRegister_DB_Routines(Cl: TPSRuntimeClassImporter);
...
begin
  with CL.AddClassN(CL.FindClass('TComponent'), 'TDataSource') do
  begin
...
procedure TDataSource_DataSet_W(Self: TDataSource; const T: TDataSet);
begin
  Self.DataSet := T;
end;

procedure TDataSource_DataSet_R(Self: TDataSource; var T: TDataSet);
begin
  T := Self.DataSet;
end;
...
begin
  ...
  begin
    ...
    RegisterMethod(@TDataSource.Free, 'Free');

    RegisterPropertyHelper(@TDataSource_DataSet_R, @TDataSource_DataSet_W, 'DataSet');
  end;
end;

procedure RIRegister_DB_Routines(Cl: TPSRuntimeClassImporter);
begin
  RIRegister_TDataSource(Cl);
end;
//end-maurog
