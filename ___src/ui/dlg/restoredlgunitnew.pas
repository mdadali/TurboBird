...
procedure TRestoreDlgNew.sbBackupFileClick(Sender: TObject);
begin
...
procedure TRestoreDlgNew.sbPrimDBFileNameClick(Sender: TObject);
begin
...
procedure TRestoreDlgNew.sbSegmentsChangeBounds(Sender: TObject);
begin
end;

procedure TRestoreDlgNew.sbSegmentsClick(Sender: TObject);
begin
  OpenDialog1.Filter := 'Database Files|*.fdb|All Files|*.*';
  if OpenDialog1.Execute then
  begin
...
procedure TRestoreDlgNew.Init(AServerName, ADatabaseName: string; ADefaultPageSize, ADefaultNumBuffers: Integer);
...
procedure TRestoreDlgNew.DoClientRestore(Data: PtrInt);
begin
...
procedure TRestoreDlgNew.DoServerRestore(Data: PtrInt);
begin
  Progressbar1.Visible := true;
...
function TRestoreDlgNew.ShowModal(DefaultPageSize,
...
procedure TRestoreDlgNew.FormShow(Sender: TObject);
begin
...
procedure TRestoreDlgNew.IBXClientSideRestoreService1GetNextLine(Sender: TObject;
  var Line: string);
begin
...
procedure TRestoreDlgNew.ReportTabShow(Sender: TObject);
begin
  Report.Lines.Clear;
end;

procedure TRestoreDlgNew.FormClose(Sender: TObject; var CloseAction: TCloseAction);
var i: integer;
begin
...
procedure TRestoreDlgNew.Button1Click(Sender: TObject);
begin
