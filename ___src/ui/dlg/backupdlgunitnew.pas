...
procedure TBackupDlgNew.SpeedButton1Click(Sender: TObject);
begin
  if SaveDialog1.Execute then
    BackupFileName.Text := SaveDialog1.Filename;
end;

procedure TBackupDlgNew.DoClientBackup(Data: PtrInt);
...
procedure TBackupDlgNew.DoServerBackup(Data: PtrInt);
begin
  ProgressBar1.Visible := true;
...
procedure TBackupDlgNew.FormShow(Sender: TObject);
begin
...
procedure TBackupDlgNew.IBXClientSideBackupService1GetNextLine(Sender: TObject;
  var Line: string);
begin
  Application.ProcessMessages;
end;

procedure TBackupDlgNew.ReportTabShow(Sender: TObject);
begin
  Report.Lines.Clear;
end;

procedure TBackupDlgNew.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
