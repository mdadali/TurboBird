...
{var
    ...
    _DBLoginDlg: TDBLoginDlg;
    _ShutdownDatabaseDlg: TShutdownDatabaseDlg;
    _ShutdownReqDlg: TShutdownReqDlg;
    _BackupDlg: TBackupDlg;
    _RestoreDlg: TRestoreDlg;
    _AddSecondaryFileDlg: TAddSecondaryFileDlg;
    _AddShadowFileDlg: TAddShadowFileDlg;
    _AddShadowSetDlg: TAddShadowSetDlg;
    _NewUserDlg: TNewUserDlg;
    _ChgPasswordDlg: TChgPasswordDlg;
    _ExecuteSQLScriptDlg: TExecuteSQLScriptDlg;
 }
...
begin
  {_DBLoginDlg.Free;
  _ShutdownDatabaseDlg.Free;
  _ShutdownReqDlg.Free;
  _BackupDlg.Free;
  _RestoreDlg.Free;
  _AddSecondaryFileDlg.Free;
  _AddShadowFileDlg.Free;
  _AddShadowSetDlg.Free;
  _NewUserDlg.Free;
  _ChgPasswordDlg.Free;
  _ExecuteSQLScriptDlg.Free;
...
begin
  ...
  Application.CreateForm(TDBLoginDlg, _DBLoginDlg);
  Application.CreateForm(TShutdownDatabaseDlg, _ShutdownDatabaseDlg);
  Application.CreateForm(TShutdownReqDlg, _ShutdownReqDlg);
  Application.CreateForm(TBackupDlg, _BackupDlg);
  Application.CreateForm(TRestoreDlg, _RestoreDlg);
  Application.CreateForm(TAddSecondaryFileDlg, _AddSecondaryFileDlg);
  Application.CreateForm(TAddShadowFileDlg, _AddShadowFileDlg);
  Application.CreateForm(TAddShadowSetDlg, _AddShadowSetDlg);
  Application.CreateForm(TNewUserDlg, _NewUserDlg);
  Application.CreateForm(TChgPasswordDlg, _ChgPasswordDlg);
  Application.CreateForm(TExecuteSQLScriptDlg, _ExecuteSQLScriptDlg);
  }
end;
